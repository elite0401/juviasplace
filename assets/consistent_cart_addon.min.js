...
Last updated: 2018-04-10 11:05:05 +0000
*****************/



window.__CONSISTENT_CART_SETTINGS = {
	'last_updated':"2018-04-10 11:05:05 +0000",
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery),TitleBarAdvanced=function e(t){_classCallCheck(this,e);try{if(window.__CONSISTENT_CART_SETTINGS.title_bar_advanced){var i,n,o,d,c,r,u,a,l,s=function(){var e=function(){document[i]?s():f()},t=function e(){a=!0,l?(document.title=r,l=!1):(document.title=c,l=!0),clearTimeout(u),u=setTimeout(e,5e3)},s=function(){u=setTimeout(t,5e3)},f=function(){if(a){var e={shopify_domain:Shopify.shop};_jquery2.default.get("https://cc-micro.herokuapp.com/title_bar_incr",e)}a=!1,clearTimeout(u),document.title=c};for(void 0!==document.hidden?(i="hidden",n="visibilitychange"):void 0!==document.msHidden?(i="msHidden",n="msvisibilitychange"):void 0!==document.webkitHidden&&(i="webkitHidden",n="webkitvisibilitychange"),void 0===document.addEventListener||void 0===document[i]||document.addEventListener(n,e,!1),o=["checkout/thank_you","/orders/","/checkouts/"],d=0;d<o.length;d++)if(window.location.href.indexOf(o[d])>-1)return{v:!0};c=document.title,r=window.__CONSISTENT_CART_SETTINGS.title_bar_text,a=!1,l=!0}();if("object"==typeof s)return s.v}}catch(e){throw e}};exports.default=TitleBarAdvanced,module.exports=exports.default;
